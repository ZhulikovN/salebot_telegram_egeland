...
LOW_PRIORITY_BOT_NAMES: frozenset[str] = frozenset({"203482421"})  # ВК — Общая группа ЕГЭ/ОГЭ
...
_BOT_CONFIGS: dict[str, BotConfig] = {
    ...
    # Этот бот-идентификатор также используется в salebot_webhook.py/queue.py
    # для маршрутизации в низкоприоритетную очередь (VK_LOW_PRIORITY_BOT_NAMES),
    # чтобы массовые ВК-рассылки не блокировали Telegram/Instagram и др.
    "203482421": BotConfig(
    ...
    "el_personal_bot": BotConfig(
        ...
        field_triggers=_COMMON_FIELD_TRIGGERS + (
            # Новые кнопки класса (смешанные кириллица/латиница, скопировано из ТЗ точно)
            ("11 клaсс", 809893, 1374875),  # → 11 класс
            ("11 клаcc", 809893, 1374875),
            ("10 клaсс", 809893, 1374873),  # → 10 класс
            ("10 клаcc", 809893, 1374873),
            ("9 клaсс",  809893, 1374871),  # → 9 класс
            ("9 клаcc",  809893, 1374871),
            ("8 клаcc",  809893, 1378767),  # → 8 класс
            ("8 клaсс",  809893, 1378767),
            # Старые кнопки — оставлены для совместимости с ранее выданными клавиатурами
            ("Перешел в 11 класс",    809893, 1374875),
            ("Перехожу в 11 класс",   809893, 1374875),
            ("Перехожу в 11-й класс", 809893, 1374875),
            ("Перешел в 10 класс",    809893, 1374873),
            ("Перехожу в 10 класс",   809893, 1374873),
            ("Перехожу в 10-й класс", 809893, 1374873),
            ("Перешел в 9 класс",     809893, 1374871),
            ("Перехожу в 9 класс",    809893, 1374871),
            ("Перехожу в 9-й класс",  809893, 1374871),
            ("Перешел в 8 класс",     809893, 1378767),
