...
_BOT_CONFIGS: dict[str, BotConfig] = {
    ...
    "el_personal_bot": BotConfig(
        ...
        field_triggers=_COMMON_FIELD_TRIGGERS + (
            # Кнопки класса — "Заканчиваю/Закончил N класс" и "Перешел/Перехожу в N класс"
            ("Заканчиваю 11 класс",   809893, 1374875),  # → 11 класс
            ("Закончил 11 класс",     809893, 1374875),
            ("Заканчиваю 11-й класс", 809893, 1374875),
            ("Перешел в 11 класс",    809893, 1374873),  # → 10 класс
            ("Перехожу в 11 класс",   809893, 1374873),
            ("Перехожу в 11-й класс", 809893, 1374873),
            ("Перешел в 10 класс",    809893, 1374871),  # → 9 класс
            ("Перехожу в 10 класс",   809893, 1374871),
            ("Перехожу в 10-й класс", 809893, 1374871),
            ("Перешел в 9 класс",     809893, 1378767),  # → 8 класс
            ("Перехожу в 9 класс",    809893, 1378767),
            ("Перехожу в 9-й класс",  809893, 1378767),
            ("Перешел в 8 класс",     809893, 1378765),  # → 7 класс
            ("Перехожу в 8 класс",    809893, 1378765),
            ("Перехожу в 8-й класс",  809893, 1378765),
        ),
    ),
}
