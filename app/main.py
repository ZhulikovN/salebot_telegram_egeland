...
from app.api import amojo_webhook, health, lead_webhook, media, salebot_webhook, telegram_webhook
...
app.include_router(telegram_webhook.router, tags=["webhooks"])
app.include_router(lead_webhook.router, tags=["webhooks"])
